import Boundary.LFunctionsRootedTreeFinal.Final.AnalyticMotives.Motives.MotivicTStructure.MathlibFields.DegreewiseBoundedSubcategory.Representatives.BoundedRoof.InternalSpan.DenominatorNullCone.Owner

/-!
# Isomorphism denominators from null-cone internal spans

This file proves that the denominator in the null-cone internal bounded roof
span is an isomorphism in the Verdier quotient.  The proof uses the analytic
distinguished triangle with null cone to reconstruct the inverted raw
denominator, then transports that isomorphism across the roof-object equality.
-/
...
/-- The null-cone internal bounded roof span may be chosen with an isomorphism
denominator. -/
theorem exists_internalRepresentativeBoundedRoofSpan_denominatorNullCone_iso
    {source target :
  ...
  Exists.elim
    (TraceAnalyticDMgmComparisonSource.DegreewiseBoundedStable
      .exists_internalRepresentativeBoundedRoofSpan_denominatorNullCone
        morphism)
