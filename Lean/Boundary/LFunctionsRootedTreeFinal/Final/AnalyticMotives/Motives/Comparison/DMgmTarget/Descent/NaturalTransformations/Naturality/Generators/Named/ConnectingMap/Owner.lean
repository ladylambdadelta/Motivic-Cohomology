...
/-!
# Named generator connecting-map naturality for Boundary DMgm descent
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_descentChannel_generator_connectingMap_naturality
    (first second :
  ...
  TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_generator_connectingMap_naturality
    (composition := composition)
    first
    second
    firstInverts
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_descentRefinement_generator_connectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_descentSchedule_generator_connectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_intervalStokes_generator_connectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_intervalFubini_generator_connectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_tateWeightDrop_generator_connectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
