...
/-!
# Degreewise constructor for field-order truncation existence

This file composes the degreewise analytic constructor for
...
/-- Degreewise short exactness at cut `1` gives the exact field-order
truncation triangle for the represented derived object. -/
theorem degreewise_exists_triangle_zero_one_fieldShape
