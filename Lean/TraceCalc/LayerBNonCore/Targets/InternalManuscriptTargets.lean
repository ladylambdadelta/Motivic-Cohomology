...
def ofInfrastructure {presentation : Type u}
  (_E : CategoryInfra.FreeDGEnvelope.{u, v} presentation) :
    FreeDGEnvelopeExistenceTarget :=
  ofProp (Nonempty (CategoryInfra.FreeDGEnvelope.{u, v} presentation))
...
def ofInfrastructure {presentation : Type u}
  ...
  ofProp (Nonempty (CategoryInfra.FreeDGUniversalProperty presentation E.envelope.Obj E.includeObj))
...
def ofStableCompletionTarget {presentation : Type u}
    (target : CategoryInfra.StableCompletionConstructionTarget presentation) :
    FreeDGEnvelopeTarget :=
  ofInfrastructure target.freeDG
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
  (_P : CategoryInfra.PretriangulatedHull C) :
    PretriangulatedHullExistenceTarget :=
  ofProp (Nonempty (CategoryInfra.PretriangulatedHull C))
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
  ...
  ofProp (Nonempty (CategoryInfra.ShiftStructure P.hull.Obj))
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
  ...
  ofProp (Nonempty (CategoryInfra.ConeStructure P.hull.Obj))
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
  ...
  ofProp
    (Nonempty
      (CategoryInfra.PretriangulatedUniversalProperty
        C.Obj P.hull.Obj P.includeObj P.shift.obj P.cone.obj))
...
def ofStableCompletionTarget {presentation : Type u}
    (target : CategoryInfra.StableCompletionConstructionTarget presentation) :
    PretriangulatedHullUniversalTarget :=
  ofInfrastructure target.pretriangulatedHull
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
  (_H : CategoryInfra.H0TriangulatedData P) : H0CategoryExistenceTarget :=
  ofProp (Nonempty (CategoryInfra.H0TriangulatedData P))

theorem ofInfrastructure_holds {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
    (H : CategoryInfra.H0TriangulatedData P) :
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
  (_H : CategoryInfra.H0TriangulatedData P) : H0DistinguishedTrianglesTarget :=
  ofProp (Nonempty (CategoryInfra.ConeStructure P.hull.Obj))
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
  (_H : CategoryInfra.H0TriangulatedData P) : H0TriangulatedAxiomsTarget :=
  ofProp
    (Nonempty
      (CategoryInfra.ShiftStructure P.hull.Obj ×
        CategoryInfra.ConeStructure P.hull.Obj))
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
  (_H : CategoryInfra.H0TriangulatedData P) : H0LocalizationAtAcyclicsTarget :=
  ofProp
    (Nonempty
      (CategoryInfra.PretriangulatedUniversalProperty
        C.Obj P.hull.Obj P.includeObj P.shift.obj P.cone.obj))
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
  (H : CategoryInfra.H0TriangulatedData P) : H0TriangulatedFieldTargets :=
  ofTargets
...
theorem ofInfrastructure_holds {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
    (H : CategoryInfra.H0TriangulatedData P) :
    (ofInfrastructure H).hZeroTriangulatedPassage := by
  exact ⟨⟨H⟩, ⟨H.distinguishedTriangles⟩, ⟨H.triangulatedAxioms⟩,
    ⟨H.localizationAtAcyclics⟩⟩
...
def ofInfrastructure {C : CategoryInfra.DGCategoryLike.{u, v}}
    {P : CategoryInfra.PretriangulatedHull C}
  (H : CategoryInfra.H0TriangulatedData P) : H0TriangulatedTarget :=
  ofFieldTargets (H0TriangulatedFieldTargets.ofInfrastructure H)

def ofStableCompletionTarget {presentation : Type u}
    (target : CategoryInfra.StableCompletionConstructionTarget presentation) :
    H0TriangulatedTarget :=
  ofInfrastructure target.homotopyCategory
...
def ofInfrastructure {K : Type _}
    (_K : K) : KaroubiEnvelopeExistenceTarget :=
  ofProp (Nonempty K)

theorem ofInfrastructure_holds {K : Type _}
    (k : K) :
...
def ofKaroubiCompletion
    {C : Type u} [CategoryTheory.Category C]
    (h : CategoryTheory.IsIdempotentComplete C) :
    IdempotentSplittingTarget :=
  ofProp (CategoryTheory.IsIdempotentComplete C)
...
def ofFunctor
    ...
    [CategoryTheory.Category D]
    (F : CategoryTheory.Functor C D) :
    KaroubiUniversalPropertyTarget :=
  ofProp (Nonempty (α := CategoryTheory.Functor C D))
...
def ofStableCompletionTarget {presentation : Type u}
    ...
    KaroubiEnvelopeUniversalTarget :=
  ofFields
    (KaroubiEnvelopeExistenceTarget.ofInfrastructure target.karoubiEnvelope)
    (IdempotentSplittingTarget.ofKaroubiCompletion
      target.exactnessTransport.exactnessForKaroubiCompletion)
    (KaroubiUniversalPropertyTarget.ofFunctor
      (CategoryInfra.StandardH0CategoryTarget.AsCategory.toKaroubi target.h0Target))
...
def ofTransportData
    {presentation : Type u}
  [CategoryInfra.MonoidalPresentation presentation]
    {F : CategoryInfra.FreeDGEnvelope.{u, v} presentation}
    {P : CategoryInfra.PretriangulatedHull F.envelope}
    {C : CategoryInfra.StandardDGCategoryLike.{u, v}}
    {H : CategoryInfra.StandardH0CategoryTarget C}
    {target : CategoryInfra.MonoidalTransportTarget F P H}
    (data : CategoryInfra.MonoidalTransportData target) :
    MonoidalLiftThroughDGEnvelopeTarget :=
  ofProp
    (∀ p q : presentation,
      target.tensorOnDG (F.includeObj p) (F.includeObj q) =
        F.includeObj (CategoryInfra.MonoidalPresentation.tensorObj p q))
...
def ofTransportData
  ...
  ofProp (Nonempty (α := CategoryInfra.H0TensorAssociator H target.tensorOnH0))
  ...
  ofProp
    (∀ X Y : C.Obj,
      target.tensorOnKaroubi
          (CategoryInfra.StandardH0CategoryTarget.AsCategory.karoubiOfObj H X)
          (CategoryInfra.StandardH0CategoryTarget.AsCategory.karoubiOfObj H Y) =
        CategoryInfra.StandardH0CategoryTarget.AsCategory.karoubiOfObj H
          (target.tensorOnH0 X Y))
...
def ofTransportData
  ...
  ofProp (Nonempty
    (α := CategoryInfra.KaroubiTensorAssociator H target.tensorOnKaroubi))
...
def ofTransportData
  ...
  [CategoryInfra.MonoidalPresentation presentation]
    ...
    {target : CategoryInfra.MonoidalTransportTarget F P H}
    (data : CategoryInfra.MonoidalTransportData target) :
    MonoidalLiftFieldTargets :=
  ofTargets
    (MonoidalLiftThroughDGEnvelopeTarget.ofTransportData data)
    (MonoidalLiftThroughPretriangulatedHullTarget.ofTransportData data)
    (MonoidalLiftThroughH0Target.ofTransportData data)
    (MonoidalLiftThroughKaroubiEnvelopeTarget.ofTransportData data)
    (MonoidalCoherenceTransportTarget.ofTransportData data)
...
def ofTransportData
  ...
  [CategoryInfra.MonoidalPresentation presentation]
    ...
    (data : CategoryInfra.MonoidalTransportData target) :
    MonoidalLiftThroughCompletionTarget :=
  ofFieldTargets (MonoidalLiftFieldTargets.ofTransportData data)

def ofStableCompletionMonoidalTransportPackage
    {presentation : Type u}
  [CategoryInfra.MonoidalPresentation presentation]
    {target : CategoryInfra.StableCompletionConstructionTarget presentation}
    (package : CategoryInfra.StableCompletionMonoidalTransportPackage target) :
    MonoidalLiftThroughCompletionTarget :=
  ofTransportData package.data
...
def ofTransportData
    ...
    {C : CategoryInfra.StandardDGCategoryLike.{u, v}}
    {H : CategoryInfra.StandardH0CategoryTarget C}
    {target : CategoryInfra.ExactnessTransportTarget F P H}
    (data : CategoryInfra.ExactnessTransportData target) :
    ExactnessForDGEnvelopeTarget :=
  ofProp F.envelope.differentialSquaredZero
...
def ofTransportData
  ...
  ofProp P.hull.differentialSquaredZero
...
def ofTransportTarget
  ...
  ofProp (Nonempty (α := CategoryInfra.H0TriangulatedData P))
...
def ofTransportTarget
  ...
  ofProp
    (CategoryTheory.IsIdempotentComplete
      (CategoryInfra.StandardH0CategoryTarget.AsCategory.KaroubiCompletion H))
...
def ofTransportTarget
  ...
  ofProp (Nonempty (α := CategoryInfra.ConeStructure P.hull.Obj))
...
def ofTransportData
  ...
  ofTargets
    (ExactnessForDGEnvelopeTarget.ofTransportData data)
    (ExactnessForPretriangulatedHullTarget.ofTransportData data)
    (ExactnessForH0Target.ofTransportTarget target)
    (ExactnessForKaroubiEnvelopeTarget.ofTransportTarget target)
    (DistinguishedTriangleTransportTarget.ofTransportTarget target)
...
def ofTransportData
    ...
    (data : CategoryInfra.ExactnessTransportData target) :
    ExactnessTransportThroughCompletionTarget :=
  ofFieldTargets (ExactnessTransportFieldTargets.ofTransportData data)

def ofStableCompletionConstructionData
    {presentation : Type u}
    {target : CategoryInfra.StableCompletionConstructionTarget presentation}
    (data : CategoryInfra.StableCompletionConstructionData target) :
    ExactnessTransportThroughCompletionTarget :=
  ofTransportData data.exactnessTransportData
...
def ofStableCompletionPackages
    {presentation : Type u}
  [CategoryInfra.MonoidalPresentation presentation]
    {target : CategoryInfra.StableCompletionConstructionTarget presentation}
    (data : CategoryInfra.StableCompletionConstructionData target)
    (monoidal : CategoryInfra.StableCompletionMonoidalTransportPackage target) :
    StableCompletionFieldTargets :=
  ofTargets
    (FreeDGEnvelopeTarget.ofStableCompletionTarget target)
    (PretriangulatedHullUniversalTarget.ofStableCompletionTarget target)
    (H0TriangulatedTarget.ofStableCompletionTarget target)
    (KaroubiEnvelopeUniversalTarget.ofStableCompletionTarget target)
    (MonoidalLiftThroughCompletionTarget.ofStableCompletionMonoidalTransportPackage
      monoidal)
    (ExactnessTransportThroughCompletionTarget.ofStableCompletionConstructionData
      data)
...
def ofStableCompletionFieldTargets
