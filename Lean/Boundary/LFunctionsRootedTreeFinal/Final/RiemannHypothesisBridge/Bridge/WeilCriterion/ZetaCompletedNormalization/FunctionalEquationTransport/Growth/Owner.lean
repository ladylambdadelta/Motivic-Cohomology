...
/-!
# Completed functional-equation growth bounds

This is the growth section of functional-equation transport, containing
left-half-plane growth bounds, reflection transport, and right-half-plane
Stirling estimates for the completed multiplier.
-/
