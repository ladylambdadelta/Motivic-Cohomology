...
/-!
# Tate-weight-drop assembly with homology discharged

This file removes the cochain-homology input from the Tate-weight-drop
...
null-homotopic cone identities, and Tate-weight-drop numerator cancellation,
with cochain homology supplied by the abelian-envelope owner theorem. -/
def tStructureOfNullHomotopicIdentityAndTateWeightDropHomologyDischarged
    (allBoundedStable :
...
/-- The homology-discharged Tate-weight-drop assembly has the analytic motivic
`LE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndTateWeightDropHomologyDischarged_LE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (nullHomotopicIdentity :
...
/-- The homology-discharged Tate-weight-drop assembly has the analytic motivic
`GE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndTateWeightDropHomologyDischarged_GE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (nullHomotopicIdentity :
