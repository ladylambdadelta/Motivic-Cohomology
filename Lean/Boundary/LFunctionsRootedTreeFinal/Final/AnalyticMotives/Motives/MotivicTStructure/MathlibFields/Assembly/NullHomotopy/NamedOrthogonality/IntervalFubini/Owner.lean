...
/-!
# Interval-Fubini assembly of the Mathlib t-structure

This file assembles Mathlib's `TStructure` record from the null-homotopy
truncation route and the named Interval-Fubini numerator-cancellation route for
orthogonality.
-/
...
identities and Interval-Fubini numerator cancellation. -/
def tStructureOfNullHomotopicIdentityAndIntervalFubini
    (allBoundedStable :
...
/-- The Interval-Fubini assembly has the analytic motivic `LE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndIntervalFubini_LE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (homology :
...
/-- The Interval-Fubini assembly has the analytic motivic `GE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndIntervalFubini_GE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (homology :
