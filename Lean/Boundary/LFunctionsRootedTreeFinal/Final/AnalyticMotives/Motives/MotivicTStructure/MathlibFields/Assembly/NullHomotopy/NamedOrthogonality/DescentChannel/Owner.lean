...
/-!
# Descent-channel assembly of the Mathlib t-structure

This file assembles Mathlib's `TStructure` record from the null-homotopy
truncation route and the named descent-channel numerator-cancellation route for
orthogonality.
-/
...
identities and descent-channel numerator cancellation. -/
def tStructureOfNullHomotopicIdentityAndDescentChannel
    (allBoundedStable :
...
/-- The descent-channel assembly has the analytic motivic `LE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndDescentChannel_LE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (homology :
...
/-- The descent-channel assembly has the analytic motivic `GE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndDescentChannel_GE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (homology :
