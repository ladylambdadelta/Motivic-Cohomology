import TraceCalc.LayerD.MotivicRecognition.Package3BProofs
...
/-!
LayerD canonical location for the admissible-localization assembly built from
the sealed Package 3B proof families.

The top-level `TraceCalc.MotivicRecognition.Package3B6Admissibility` module is
