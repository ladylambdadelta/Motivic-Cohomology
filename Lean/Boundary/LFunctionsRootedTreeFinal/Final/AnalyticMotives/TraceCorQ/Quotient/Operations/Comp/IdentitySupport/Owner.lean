...
left- and right-identity coherence cells for ledgered trace transports, then
uses Q-linear cancellation to turn those support relations into singleton
identity laws.
...
def LedgeredTraceTransport.leftIdentitySupportRelation
  ...
  TraceCorQQuotientRelation.ofWitness
    (LedgeredTraceTransport.leftIdentitySupportWitness transport)
...
def LedgeredTraceTransport.rightIdentitySupportRelation
    ...
    TraceCorQQuotientRelation
      ...
      TraceCorQQuotientCandidate.empty :=
  TraceCorQQuotientRelation.ofWitness
    (LedgeredTraceTransport.rightIdentitySupportWitness transport)
...
theorem LedgeredTraceTransport.leftIdentitySupportQuotient_eq_zero
  ...
  TraceCorQQuotient.sound
    (LedgeredTraceTransport.leftIdentitySupportRelation transport)
...
theorem LedgeredTraceTransport.rightIdentitySupportQuotient_eq_zero
    ...
    TraceCorQQuotient.ofCandidate
      ...
      TraceCorQQuotient.zero :=
  TraceCorQQuotient.sound
    (LedgeredTraceTransport.rightIdentitySupportRelation transport)
