...
/-!
# Global probe-degree data for family boundary handoff

This file specializes global probe-degree exactness data to the represented
family boundary handoff certificate at an arbitrary derived analytic motive.
-/
...
/-- Global probe-degree exactness plus represented-family boundary handoff
gives the represented boundary identification and current constructor-order
t-structure-facing fields at every chosen derived object and represented
truncation object. -/
theorem family_globalProbeDegree_boundaryHandoff_certificate
    (opcyclesSplit :
      ∀ represented :
...
/-- Global probe-degree exactness plus represented-family boundary handoff
gives the literal represented opcycles boundary identification and current
constructor-order fields at every chosen derived object and represented
truncation object. -/
theorem family_globalProbeDegree_boundaryHandoff_literalOpcycles_certificate
    (opcyclesSplit :
      ∀ represented :
        TraceAnalyticMotivicTStructure.RepresentedTruncationObject,
        letI : ∀ degree : ℤ,
