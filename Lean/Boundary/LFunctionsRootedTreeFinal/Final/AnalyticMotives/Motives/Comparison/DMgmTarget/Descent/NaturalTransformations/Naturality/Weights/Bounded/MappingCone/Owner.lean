...
/-!
# Boundary DMgm descended naturality for bounded mapping cones

This file specializes descended-natural-transformation naturality to the first
three stable maps of bounded analytic mapping-cone comparison data.
-/
...
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_mappingConeFirstMap_naturality
    (first second :
...
second stable map of a bounded analytic mapping-cone triangle. -/
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_mappingConeSecondMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
...
/-- Naturality of a Boundary-DMgm descended natural transformation on the
stable connecting map of a bounded analytic mapping-cone triangle. -/
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_mappingConeConnectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget (composition := composition))
    (firstInverts :
