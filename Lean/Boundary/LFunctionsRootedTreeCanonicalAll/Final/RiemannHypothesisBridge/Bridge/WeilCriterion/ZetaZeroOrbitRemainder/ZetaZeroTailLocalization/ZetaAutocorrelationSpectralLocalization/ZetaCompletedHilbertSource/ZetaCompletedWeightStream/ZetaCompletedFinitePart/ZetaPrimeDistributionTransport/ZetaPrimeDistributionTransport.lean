  ...
  have htransport :
      Complex.re
        ...
        Complex.re
          (zetaCompletedExplicitFormulaPrimePowerSpectralSampleContribution
            (convolutionAutocorrelation f)) :=
    zetaCompletedExplicitFormulaPrimePowerContribution_re_eq_spectralSampleContribution_re_ownerDistributionTransport
      f
  have hspectral :
      completedSpectralPrimeOffDiagonalChannel f =
        Complex.re
          (zetaCompletedExplicitFormulaPrimePowerSpectralSampleContribution
            (convolutionAutocorrelation f)) :=
    rfl
  exact htime.trans (htransport.trans hspectral.symm)
