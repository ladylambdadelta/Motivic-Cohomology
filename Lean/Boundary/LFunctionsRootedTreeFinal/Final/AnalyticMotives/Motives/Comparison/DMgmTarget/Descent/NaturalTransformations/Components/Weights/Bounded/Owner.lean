import Boundary.LFunctionsRootedTreeFinal.Final.AnalyticMotives.Motives.Comparison.DMgmTarget.Descent.NaturalTransformations.Components.Owner
...
/-!
# Components of descended transformations on bounded analytic weights

This file specializes the represented-object component formula for descended
Boundary-DMgm natural transformations to stable bounded analytic complexes.
-/
...
/-- At a stable bounded analytic object, a Boundary-DMgm descended natural
transformation is the original transformation conjugated by the bounded descent
factorization isomorphisms. -/
theorem TraceAnalyticDMgmComparisonTarget.descendInvertingFunctorNatTrans_app_boundedObject
    (first second :
