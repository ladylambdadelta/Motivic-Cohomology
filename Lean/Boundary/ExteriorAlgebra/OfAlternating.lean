...
/-!
# Local exterior-algebra lift from alternating maps

This is a local copy of the minimal `liftAlternating` API needed by the de Rham
realization owner files. It mirrors the corresponding Mathlib construction.
-/
