...
/-!
# Derived scalar-linearity laws for typed composition

This file re-exports scalar normalization and sign-normalization laws derived
from the base scalar-linearity owner.
-/
