...
/-!
# Projections from the probe-degree field-order certificate

This file exposes the individual constructor-order fields obtained from
...
/-- The probe-degree constructor-order certificate gives adjacent monotonicity
of the analytic aisle predicate. -/
theorem current_full_probeDegree_tStructureLE_zero_le
    (represented :
...
/-- The probe-degree constructor-order certificate gives adjacent monotonicity
of the analytic coaisle predicate. -/
theorem current_full_probeDegree_tStructureGE_one_le
    (represented :
      TraceAnalyticMotivicTStructure.RepresentedTruncationObject)
    (object : TraceAnalyticDerivedMotiveCategory)
    (hlowerExact :
...
/-- The probe-degree constructor-order certificate gives the adjacent
truncation triangle existence field. -/
theorem current_full_probeDegree_truncation_triangle
    (represented :
      TraceAnalyticMotivicTStructure.RepresentedTruncationObject)
    (object : TraceAnalyticDerivedMotiveCategory)
    (hlowerExact :
...
/-- The probe-degree constructor-order certificate gives represented-object
orthogonality. -/
theorem current_full_probeDegree_represented_firstMap_secondMap
    (represented :
      TraceAnalyticMotivicTStructure.RepresentedTruncationObject)
    (object : TraceAnalyticDerivedMotiveCategory)
    (hlowerExact :
