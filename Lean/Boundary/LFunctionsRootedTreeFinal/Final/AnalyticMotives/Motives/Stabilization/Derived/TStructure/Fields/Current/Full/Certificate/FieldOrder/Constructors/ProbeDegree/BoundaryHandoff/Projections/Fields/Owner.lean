import Boundary.LFunctionsRootedTreeFinal.Final.AnalyticMotives.Motives.Stabilization.Derived.TStructure.Fields.Current.Full.Certificate.FieldOrder.Constructors.ProbeDegree.BoundaryHandoff.Projections.Owner

/-!
# Field projections from the probe-degree boundary handoff

This file exposes the remaining constructor-order t-structure fields carried
by the probe-degree boundary handoff package.
-/
...
theorem current_full_probeDegree_boundaryHandoff_tStructureGE_one_le
    (represented :
  ...
  exact
    (represented
      .current_full_probeDegree_boundaryHandoff_comparison_isIso_certificate
        ...
        hlowerMono
        hoffExact
        hoffEpi).right.right.left

/-- The probe-degree boundary handoff gives adjacent truncation triangle
existence. -/
theorem current_full_probeDegree_boundaryHandoff_truncation_triangle
    (represented :
      TraceAnalyticMotivicTStructure.RepresentedTruncationObject)
    (object : TraceAnalyticDerivedMotiveCategory)
    (opcyclesSplit :
  ...
  exact
    (represented
      .current_full_probeDegree_boundaryHandoff_comparison_isIso_certificate
        ...
        hlowerMono
        hoffExact
        hoffEpi).right.right.right.left

/-- The probe-degree boundary handoff gives represented-object
zero-composition. -/
theorem current_full_probeDegree_boundaryHandoff_represented_firstMap_secondMap
    (represented :
      TraceAnalyticMotivicTStructure.RepresentedTruncationObject)
    (object : TraceAnalyticDerivedMotiveCategory)
    (opcyclesSplit :
  ...
  exact
    (represented
      .current_full_probeDegree_boundaryHandoff_comparison_isIso_certificate
        ...
        hlowerMono
        hoffExact
        hoffEpi).right.right.right.right
