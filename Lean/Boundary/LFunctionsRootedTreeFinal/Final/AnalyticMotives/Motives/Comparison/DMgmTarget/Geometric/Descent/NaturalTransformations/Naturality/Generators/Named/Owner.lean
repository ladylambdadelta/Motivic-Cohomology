import Boundary.LFunctionsRootedTreeFinal.Final.AnalyticMotives.Motives.Comparison.DMgmTarget.Geometric.Descent.NaturalTransformations.Naturality.Generators.Owner
import Boundary.LFunctionsRootedTreeFinal.Final.AnalyticMotives.Motives.Comparison.DMgmTarget.Geometric.Descent.NaturalTransformations.Naturality.Generators.Named.ConeMap.Owner
import Boundary.LFunctionsRootedTreeFinal.Final.AnalyticMotives.Motives.Comparison.DMgmTarget.Geometric.Descent.NaturalTransformations.Naturality.Generators.Named.ConnectingMap.Owner

/-!
# Named generator first-map naturality for geometric Boundary DMgm descent
...
the matching cone-map and connecting-map named naturality layers, for functors
landing in the geometric Boundary DMgm target.
-/
...
/-- Naturality on descent-channel stable acyclic generator first maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_descentChannel_generator_firstMap_naturality
    (first second :
  ...
  TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_generator_firstMap_naturality
    (composition := composition)
    twistData
    first
    second
...
/-- Naturality on descent-refinement stable acyclic generator first maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_descentRefinement_generator_firstMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on descent-schedule stable acyclic generator first maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_descentSchedule_generator_firstMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on interval-Stokes stable acyclic generator first maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_intervalStokes_generator_firstMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on interval-Fubini stable acyclic generator first maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_intervalFubini_generator_firstMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on Tate-weight-drop stable acyclic generator first maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_tateWeightDrop_generator_firstMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
