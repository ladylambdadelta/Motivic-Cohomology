...
namespace GeometricBettiRealizationData

/-- Helper constructor for the geometric Betti realization target. -/
def ofObjectAndCarrier
    {ctx : ClassicalComparisonContext.{u, v}}
    (geometricObject : GeometricPeriodObject ctx)
    (carrier : BettiRealizationCarrier ctx)
    (geometricOriginTarget realizationFunctorialityTarget : Prop) :
    GeometricBettiRealizationData ctx where
  geometricObject := geometricObject
  carrier := carrier
  geometricOriginTarget := geometricOriginTarget
  realizationFunctorialityTarget := realizationFunctorialityTarget

@[simp] theorem ofObjectAndCarrier_geometricObject
    {ctx : ClassicalComparisonContext.{u, v}}
    (geometricObject : GeometricPeriodObject ctx)
    (carrier : BettiRealizationCarrier ctx)
    (geometricOriginTarget realizationFunctorialityTarget : Prop) :
    (ofObjectAndCarrier geometricObject carrier geometricOriginTarget realizationFunctorialityTarget).geometricObject =
      geometricObject := rfl

@[simp] theorem ofObjectAndCarrier_carrier
    {ctx : ClassicalComparisonContext.{u, v}}
    (geometricObject : GeometricPeriodObject ctx)
    (carrier : BettiRealizationCarrier ctx)
    (geometricOriginTarget realizationFunctorialityTarget : Prop) :
    (ofObjectAndCarrier geometricObject carrier geometricOriginTarget realizationFunctorialityTarget).carrier =
      carrier := rfl

@[simp] theorem ofObjectAndCarrier_geometricOriginTarget
    {ctx : ClassicalComparisonContext.{u, v}}
    (geometricObject : GeometricPeriodObject ctx)
    (carrier : BettiRealizationCarrier ctx)
    (geometricOriginTarget realizationFunctorialityTarget : Prop) :
    (ofObjectAndCarrier geometricObject carrier geometricOriginTarget realizationFunctorialityTarget).geometricOriginTarget =
      geometricOriginTarget := rfl

@[simp] theorem ofObjectAndCarrier_realizationFunctorialityTarget
    {ctx : ClassicalComparisonContext.{u, v}}
    (geometricObject : GeometricPeriodObject ctx)
    (carrier : BettiRealizationCarrier ctx)
    (geometricOriginTarget realizationFunctorialityTarget : Prop) :
    (ofObjectAndCarrier geometricObject carrier geometricOriginTarget realizationFunctorialityTarget).realizationFunctorialityTarget =
      realizationFunctorialityTarget := rfl

end GeometricBettiRealizationData
...
namespace GeometricDeRhamRealizationData

/-- Helper constructor for the geometric de Rham realization target. -/
def ofObjectAndCarrier
    {ctx : ClassicalComparisonContext.{u, v}}
    (geometricObject : GeometricPeriodObject ctx)
    (carrier : DeRhamRealizationCarrier ctx)
    (geometricOriginTarget realizationFunctorialityTarget : Prop) :
    GeometricDeRhamRealizationData ctx where
  geometricObject := geometricObject
  carrier := carrier
  geometricOriginTarget := geometricOriginTarget
  realizationFunctorialityTarget := realizationFunctorialityTarget
...
end GeometricDeRhamRealizationData
...
namespace GrothendieckComparisonData

/-- Helper constructor for the geometric comparison target. -/
def ofBettiDeRhamComparison
    {ctx : ClassicalComparisonContext.{u, v}}
    (betti : GeometricBettiRealizationData ctx)
    (deRham : GeometricDeRhamRealizationData ctx)
    (comparison : ComparisonIsomorphismData ctx betti.carrier deRham.carrier)
    (sameUnderlyingObject : betti.geometricObject = deRham.geometricObject)
    (grothendieckComparisonTarget periodCompatibilityTarget : Prop) :
    GrothendieckComparisonData ctx betti deRham where
  comparison := comparison
  sameUnderlyingObject := sameUnderlyingObject
  grothendieckComparisonTarget := grothendieckComparisonTarget
  periodCompatibilityTarget := periodCompatibilityTarget

@[simp] theorem ofBettiDeRhamComparison_comparison
    {ctx : ClassicalComparisonContext.{u, v}}
    (betti : GeometricBettiRealizationData ctx)
    (deRham : GeometricDeRhamRealizationData ctx)
    (comparison : ComparisonIsomorphismData ctx betti.carrier deRham.carrier)
    (sameUnderlyingObject : betti.geometricObject = deRham.geometricObject)
    (grothendieckComparisonTarget periodCompatibilityTarget : Prop) :
    (ofBettiDeRhamComparison betti deRham comparison sameUnderlyingObject
      grothendieckComparisonTarget periodCompatibilityTarget).comparison = comparison := rfl

@[simp] theorem ofBettiDeRhamComparison_sameUnderlyingObject
    {ctx : ClassicalComparisonContext.{u, v}}
    (betti : GeometricBettiRealizationData ctx)
    (deRham : GeometricDeRhamRealizationData ctx)
    (comparison : ComparisonIsomorphismData ctx betti.carrier deRham.carrier)
    ...
    (grothendieckComparisonTarget periodCompatibilityTarget : Prop) :
    (ofBettiDeRhamComparison betti deRham comparison sameUnderlyingObject
      grothendieckComparisonTarget periodCompatibilityTarget).sameUnderlyingObject = sameUnderlyingObject := rfl

@[simp] theorem ofBettiDeRhamComparison_grothendieckComparisonTarget
    {ctx : ClassicalComparisonContext.{u, v}}
    (betti : GeometricBettiRealizationData ctx)
    (deRham : GeometricDeRhamRealizationData ctx)
    (comparison : ComparisonIsomorphismData ctx betti.carrier deRham.carrier)
    ...
    (grothendieckComparisonTarget periodCompatibilityTarget : Prop) :
    (ofBettiDeRhamComparison betti deRham comparison sameUnderlyingObject
      grothendieckComparisonTarget periodCompatibilityTarget).grothendieckComparisonTarget =
        grothendieckComparisonTarget := rfl

@[simp] theorem ofBettiDeRhamComparison_periodCompatibilityTarget
    {ctx : ClassicalComparisonContext.{u, v}}
    (betti : GeometricBettiRealizationData ctx)
    (deRham : GeometricDeRhamRealizationData ctx)
    (comparison : ComparisonIsomorphismData ctx betti.carrier deRham.carrier)
    ...
    (grothendieckComparisonTarget periodCompatibilityTarget : Prop) :
    (ofBettiDeRhamComparison betti deRham comparison sameUnderlyingObject
      grothendieckComparisonTarget periodCompatibilityTarget).periodCompatibilityTarget =
        periodCompatibilityTarget := rfl

end GrothendieckComparisonData
...
@[simp] theorem ofFunctorialityAndFramedData_geometricRealizationFunctor
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (packedReconstruction :
      BasisFreePeriodMapDeterminesPackedComparison
        ...
        basisFreePeriodMapEquality
        structuredEq) :
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).geometricRealizationFunctor = geometricRealizationFunctor := rfl

@[simp] theorem ofFunctorialityAndFramedData_geometricFramedFunctoriality
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).geometricFramedFunctoriality = geometricFramedFunctoriality := rfl

@[simp] theorem ofFunctorialityAndFramedData_geometricComparisonNaturality
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).geometricComparisonNaturality = geometricComparisonNaturality := rfl

@[simp] theorem ofFunctorialityAndFramedData_geometricObjectData
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).geometricObjectData = geometricObjectData := rfl

@[simp] theorem ofFunctorialityAndFramedData_objectDataCompatibilityTarget
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).objectDataCompatibilityTarget = objectDataCompatibilityTarget := rfl

@[simp] theorem ofFunctorialityAndFramedData_ProbeIndex
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).ProbeIndex = ProbeIndex := rfl

@[simp] theorem ofFunctorialityAndFramedData_geometricFramedDatum
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).geometricFramedDatum = geometricFramedDatum := rfl

@[simp] theorem ofFunctorialityAndFramedData_geometricToConcreteFramed
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).geometricToConcreteFramed = geometricToConcreteFramed := rfl

@[simp] theorem ofFunctorialityAndFramedData_basisFreePeriodMapEquality
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).basisFreePeriodMapEquality = basisFreePeriodMapEquality := rfl

@[simp] theorem ofFunctorialityAndFramedData_probeExtensionality
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).probeExtensionality = probeExtensionality := rfl

@[simp] theorem ofFunctorialityAndFramedData_packedReconstruction
    {ctx : ClassicalComparisonContext.{u, v}}
    {structuredEq : StructuredComparisonEquality ctx}
    (geometricRealizationFunctor : GeometricRealizationFunctorData ctx)
    (geometricFramedFunctoriality :
    ...
    (ofFunctorialityAndFramedData geometricRealizationFunctor geometricFramedFunctoriality
      geometricComparisonNaturality geometricObjectData objectDataCompatibilityTarget ProbeIndex
      geometricFramedDatum geometricToConcreteFramed basisFreePeriodMapEquality probeExtensionality
      packedReconstruction).packedReconstruction = packedReconstruction := rfl
