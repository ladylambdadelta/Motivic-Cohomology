...
/-!
# Diagonal residual coordinate functional

This file owns the functional-analytic representation of the completed
diagonal-debt coordinate residual used by holographic trace separation.
-/
...
theorem exists_zetaCompletedPrimeDefectKernelDiagonalDebtCoordinateTsum_re_boundedCoordinateCoefficient_of_positiveOffDiagonalGap_eq_zero_ownerHolographicTraceSeparation
...
theorem exists_zetaCompletedPrimeDefectKernelDiagonalDebtCoordinateTsum_re_coordinateFunctional_of_positiveOffDiagonalGap_eq_zero_ownerHolographicTraceSeparation
    (hbranch : Complex.BinetSecondFormulaBranchUniformTailAbsorption)
    (hpartialOneTwo : BoundaryLineOneAbelPartialMajorant)
    (hcompactOneTwo : PoleClearedOneTwoStripCompactBoundaryBound)
    (hfinite : PoleClearedRightCriticalStripAdmissibleGrowth)
      ...
      ((Complex.re
        ...
        L
          (zetaCompletedZeroSideCoordinateL1LinearMap
            ...
            hpartialLeft hcompactBoundary f) :=
  match
    exists_zetaCompletedPrimeDefectKernelDiagonalDebtCoordinateTsum_re_boundedCoordinateCoefficient_of_positiveOffDiagonalGap_eq_zero_ownerHolographicTraceSeparation
      hbranch hpartialOneTwo hcompactOneTwo hfinite hpartialLeft
      hcompactBoundary f D hmajorant hgapZero
  with
