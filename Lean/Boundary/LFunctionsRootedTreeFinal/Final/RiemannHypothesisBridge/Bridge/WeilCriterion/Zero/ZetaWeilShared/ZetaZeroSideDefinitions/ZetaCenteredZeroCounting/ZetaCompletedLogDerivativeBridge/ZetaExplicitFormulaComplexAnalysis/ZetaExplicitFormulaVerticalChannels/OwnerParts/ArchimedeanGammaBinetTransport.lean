...
/-- The named right Binet-main kernel integral is definitionally the expanded
right Binet-main integral. -/
theorem zetaCompletedExplicitFormulaArchimedeanRightBinetMainKernel_integral_eq_expandedIntegral_ownerTransport
    (f : ZetaAdmissibleFunction)
    (F : ExplicitFormulaContourFamily) :
    (∫ t : ℝ,
      zetaCompletedExplicitFormulaArchimedeanRightBinetMainKernel f F t) =
