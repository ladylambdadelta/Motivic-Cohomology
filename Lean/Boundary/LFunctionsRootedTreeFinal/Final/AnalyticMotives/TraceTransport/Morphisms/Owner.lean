...
The morphisms are generated by certified rewrite traces: Stokes moves, residue
extraction, channel splitting, refinement, scheduling exchange, weight-drop
reduction, and Fubini coherence.
-/
