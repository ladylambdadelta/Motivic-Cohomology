...
/-!
# Generator naturality for full recognition natural transformations

This file specializes descended Boundary-DMgm natural-transformation
generator naturality to full recognition functors induced from geometric
recognition data.
-/
...
/-- Naturality of a full-from-geometric descended natural transformation on
the first map of a stable acyclic generator. -/
theorem TraceAnalyticMotiveRecognition.descendedFullDMgmFunctorFromGeometricNatTrans_generator_firstMap_naturality
    (first second :
...
theorem TraceAnalyticMotiveRecognition.descendedFullDMgmFunctorFromGeometricNatTrans_generator_coneMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
theorem TraceAnalyticMotiveRecognition.descendedFullDMgmFunctorFromGeometricNatTrans_generator_connectingMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
