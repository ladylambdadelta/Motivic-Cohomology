...
/-!
# Tate-weight-drop assembly of the Mathlib t-structure

This file assembles Mathlib's `TStructure` record from the null-homotopy
truncation route and the named Tate-weight-drop numerator-cancellation route for
orthogonality.
-/
...
identities and Tate-weight-drop numerator cancellation. -/
def tStructureOfNullHomotopicIdentityAndTateWeightDrop
    (allBoundedStable :
...
/-- The Tate-weight-drop assembly has the analytic motivic `LE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndTateWeightDrop_LE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (homology :
...
/-- The Tate-weight-drop assembly has the analytic motivic `GE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndTateWeightDrop_GE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (homology :
...
/-- The Tate-weight-drop assembly supplies the concrete orthogonality field. -/
...
/-- The Tate-weight-drop assembly supplies the concrete
