...
/-!
# Descent-channel assembly with homology discharged

This file removes the cochain-homology input from the descent-channel
...
null-homotopic cone identities, and descent-channel numerator cancellation,
with cochain homology supplied by the abelian-envelope owner theorem. -/
def tStructureOfNullHomotopicIdentityAndDescentChannelHomologyDischarged
    (allBoundedStable :
...
/-- The homology-discharged descent-channel assembly has the analytic motivic
`LE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndDescentChannelHomologyDischarged_LE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (nullHomotopicIdentity :
...
/-- The homology-discharged descent-channel assembly has the analytic motivic
`GE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndDescentChannelHomologyDischarged_GE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (nullHomotopicIdentity :
