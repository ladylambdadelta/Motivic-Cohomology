...
def ofLocalizationPiZeroShadowTheorem
  ...
  verdierLocalizationPiZeroShadow_holds :=
    piZeroShadowTheorem.verdierLocalizationPiZeroShadow_holds
...
def LayerBConcreteSourceData.toSourceTracePackage
  ...
  localizationCompatibility :=
    { weakEquivalenceAlignment :=
        localizationData.localizationMatchesTheorem.weakEquivalenceAlignment
      localizeObjAlignment :=
...
def concretePreferredInternalHolographyInterface
  ...
  boundaryPresentation :=
    theorem_named_free_syntax_gives_boundary_presentation
      (aux := concretePreferredBoundaryBridgeAuxiliaryData aux)
      presentation
      boundaryCodes.toConcretePreferredAuxiliaryData
      proofs
...
theorem concretePreferredInternalHolographyInterface_realizes_InternalHolographyQuotientCongruenceTarget_of_concreteTensorReassembly
  ...
  exact
    concretePreferredTensorReassemblyTarget_realizes_InternalHolographyQuotientCongruenceTarget
      ...
      (concretePreferredTensorReassemblyTarget_inhabited
        (concretePreferredInternalHolographyInterface
          presentation sourceExport boundaryCodes proofs))
...
def layerBSourceExportData_to_SourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    {presentation : NamedDoctrinePresentation primitive}
    {aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine}
    (exportData : LayerBSourceExportData presentation aux) :
    LayerD.SourceTracePackage.SourceConstructionWitness
      (layerBSourceExportData_to_SourceTracePackage exportData) where
  symmetricMonoidalPiZero := exportData.symmetricMonoidalWitness.symmetricMonoidalPiZero
  symmetricMonoidalPiZero_holds := exportData.symmetricMonoidalWitness.symmetricMonoidalPiZero_holds
  symmetricMonoidalInfinity := exportData.symmetricMonoidalWitness.symmetricMonoidalInfinity
  symmetricMonoidalInfinity_holds :=
    exportData.symmetricMonoidalWitness.symmetricMonoidalInfinity_holds
  triangulatedStablePiZero := exportData.stableTriangulatedWitness.triangulatedStablePiZero
  triangulatedStablePiZero_holds :=
    exportData.stableTriangulatedWitness.triangulatedStablePiZero_holds
  triangulatedStableInfinity := exportData.stableTriangulatedWitness.triangulatedStableInfinity
  triangulatedStableInfinity_holds :=
    exportData.stableTriangulatedWitness.triangulatedStableInfinity_holds
  a1InvariancePiZero := exportData.localGeometryWitness.a1InvariancePiZeroTicket.theoremTarget
  a1InvariancePiZero_holds :=
    exportData.localGeometryWitness.a1InvariancePiZeroTicket.theoremTarget_holds
  a1InvarianceInfinity :=
    exportData.localGeometryWitness.a1InvarianceInfinityTicket.a1InvarianceInfinity
  a1InvarianceInfinity_holds :=
    exportData.localGeometryWitness.a1InvarianceInfinityTicket.a1InvarianceInfinity_holds
  nisnevichDescentPiZero :=
    exportData.localGeometryWitness.nisnevichDescentPiZeroTicket.nisnevichDescentPiZero
  nisnevichDescentPiZero_holds :=
    exportData.localGeometryWitness.nisnevichDescentPiZeroTicket.nisnevichDescentPiZero_holds
  nisnevichDescentInfinity :=
    exportData.localGeometryWitness.nisnevichDescentInfinityTicket.nisnevichDescentInfinity
  nisnevichDescentInfinity_holds :=
    exportData.localGeometryWitness.nisnevichDescentInfinityTicket.nisnevichDescentInfinity_holds
  localizationPiZero :=
    exportData.localGeometryWitness.localizationPiZeroTicket.verdierLocalizationPiZeroShadow
  localizationPiZero_holds :=
    exportData.localGeometryWitness.localizationPiZeroTicket.verdierLocalizationPiZeroShadow_holds
  localizationInfinity :=
    exportData.localGeometryWitness.localizationInfinityTicket.localizationUniversalPropertyInfinity
  localizationInfinity_holds :=
    exportData.localGeometryWitness.localizationInfinityTicket.localizationUniversalPropertyInfinity_holds
  tateStabilizationPiZero := exportData.tateWitness.tateStabilizationPiZero
  tateStabilizationPiZero_holds := exportData.tateWitness.tateStabilizationPiZero_holds
  tateStabilizationInfinity := exportData.tateWitness.tateStabilizationInfinity
  tateStabilizationInfinity_holds := exportData.tateWitness.tateStabilizationInfinity_holds
...
/-- Package the existing candidate witness clusters as a Layer D source
construction witness through the internal holography interface. -/
def toSourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    {presentation : NamedDoctrinePresentation primitive}
    {aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine}
    (I : InternalHolographyInterface presentation aux) :
    LayerD.SourceTracePackage.SourceConstructionWitness I.toSourceTracePackage :=
  layerBSourceExportData_to_SourceConstructionWitness I.sourceExport

/-- The internal holography interface already feeds the Layer D source witness
surface through the existing Layer B export seam. -/
theorem feeds_SourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    {presentation : NamedDoctrinePresentation primitive}
    {aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine}
    (I : InternalHolographyInterface presentation aux) :
    (I.toSourceConstructionWitness).readinessData :=
  LayerD.SourceTracePackage.SourceConstructionWitness.readinessData_of_fields
    I.toSourceConstructionWitness

/-- Stronger seam theorem: the internal holography interface feeds the actual
`SourceConstructionReady` milestone through the existing Layer D theorem. -/
theorem feeds_SourceConstructionReady
    {primitive : NamedPrimitiveInterfacePresentation}
    {presentation : NamedDoctrinePresentation primitive}
    {aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine}
    (I : InternalHolographyInterface presentation aux) :
    LayerD.MilestonePrerequisitesSatisfied [] LayerD.SourceConstructionReady ∧
      ∀ obligationId : LayerD.MotivicObligationId,
        obligationId ∈ LayerD.SourceConstructionReady.requiredObligations →
          (I.toSourceConstructionWitness).SupportsObligationId obligationId :=
  LayerD.sourceTracePackage_supports_sourceConstructionReady
...
theorem internalHolographyInterface_fromMotivicLocalizationCandidate_feeds_SourceConstructionReady
    {primitive : NamedPrimitiveInterfacePresentation}
    {presentation : NamedDoctrinePresentation primitive}
    (aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine)
    (pkg : NamedFreeSourceHolographyPackage presentation aux)
    ...
    LayerD.MilestonePrerequisitesSatisfied [] LayerD.SourceConstructionReady ∧
      ∀ obligationId : LayerD.MotivicObligationId,
        obligationId ∈ LayerD.SourceConstructionReady.requiredObligations →
          (I.toSourceConstructionWitness).SupportsObligationId obligationId := by
  exact
    (internalHolographyInterface_fromMotivicLocalizationCandidate
      (pkg := pkg) ML symmetricMonoidalWitness stableTriangulatedWitness
      localGeometryWitness tateWitness).feeds_SourceConstructionReady

end InternalHolographyInterface

/-- For the `MotivicLocalization`-generated candidate path, the explicit
symmetric-monoidal theorem surface is consumed by the Layer D source witness
exactly through the existing export seam. No monoidal obligation is collapsed
into definitional equality here: the bridge only forwards the supplied witness
fields. -/
theorem motivicLocalization_candidate_symmetricMonoidalWitness_feeds_SourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    (presentation : NamedDoctrinePresentation primitive)
    (aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine)
    (pkg : NamedFreeSourceHolographyPackage presentation aux)
    ...
    let exportData :=
      layerBSourceExportData_fromMotivicLocalizationCandidate
        (pkg := pkg) ML symmetricMonoidalWitness stableTriangulatedWitness
        localGeometryWitness tateWitness
    let sourceWitness := layerBSourceExportData_to_SourceConstructionWitness exportData
    sourceWitness.symmetricMonoidalPiZero = symmetricMonoidalWitness.symmetricMonoidalPiZero ∧
      sourceWitness.symmetricMonoidalInfinity = symmetricMonoidalWitness.symmetricMonoidalInfinity := by
  exact ⟨rfl, rfl⟩

/-- For the `MotivicLocalization`-generated candidate path, the explicit
stable/triangulated theorem surface is consumed by the Layer D source witness
exactly through the existing export seam. -/
theorem motivicLocalization_candidate_stableTriangulatedWitness_feeds_SourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    (presentation : NamedDoctrinePresentation primitive)
    (aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine)
    (pkg : NamedFreeSourceHolographyPackage presentation aux)
    ...
    let exportData :=
      layerBSourceExportData_fromMotivicLocalizationCandidate
        ...
        localGeometryWitness tateWitness
    let sourceWitness := layerBSourceExportData_to_SourceConstructionWitness exportData
    sourceWitness.triangulatedStablePiZero = stableTriangulatedWitness.triangulatedStablePiZero ∧
      sourceWitness.triangulatedStableInfinity = stableTriangulatedWitness.triangulatedStableInfinity := by
  exact ⟨rfl, rfl⟩

/-- For the `MotivicLocalization`-generated candidate path, the explicit
local-geometry theorem surface is consumed by the Layer D source witness
exactly through the existing export seam. -/
theorem motivicLocalization_candidate_localGeometryWitness_feeds_SourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    (presentation : NamedDoctrinePresentation primitive)
    (aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine)
    (pkg : NamedFreeSourceHolographyPackage presentation aux)
...
theorem surface is consumed by the Layer D source witness exactly through the
existing export seam. -/
theorem motivicLocalization_candidate_tateWitness_feeds_SourceConstructionWitness
    {primitive : NamedPrimitiveInterfacePresentation}
    (presentation : NamedDoctrinePresentation primitive)
    (aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine)
    (pkg : NamedFreeSourceHolographyPackage presentation aux)
    ...
    let exportData :=
      layerBSourceExportData_fromMotivicLocalizationCandidate
        ...
        localGeometryWitness tateWitness
    let sourceWitness := layerBSourceExportData_to_SourceConstructionWitness exportData
    sourceWitness.tateStabilizationPiZero = tateWitness.tateStabilizationPiZero ∧
      sourceWitness.tateStabilizationInfinity = tateWitness.tateStabilizationInfinity := by
  exact ⟨rfl, rfl⟩

/-- Compose the existing Layer D theorem that a source trace package together
with a source construction witness realizes `SourceConstructionReady`. -/
def layerBSourceExportData_supports_SourceConstructionReady
    {primitive : NamedPrimitiveInterfacePresentation}
    {presentation : NamedDoctrinePresentation primitive}
    {aux : FoundationsBoundaryBridgeAuxiliaryData presentation.toDoctrine}
    (exportData : LayerBSourceExportData presentation aux) :
  ...
  LayerD.sourceTracePackage_gives_sourceConstructionReady
    (layerBSourceExportData_to_SourceTracePackage exportData)
    (layerBSourceExportData_to_SourceConstructionWitness exportData)
