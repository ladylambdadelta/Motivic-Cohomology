...
/-!
# Cut-transport formulas for shifted heart-to-window interval representatives

This file records how translated exact-degree heart representatives behave
when a translated enclosing interval window is widened by cut transport.
-/
...
inner interval window and then applying translated wider-window cut transport
gives the translated window representative constructed directly in the
translated outer window. -/
theorem TraceAnalyticMotivicTStructure.Heart.ofShiftedBoundedSelfAddRight_toWindowAddRight_liftToWiderOfPointwiseEq
