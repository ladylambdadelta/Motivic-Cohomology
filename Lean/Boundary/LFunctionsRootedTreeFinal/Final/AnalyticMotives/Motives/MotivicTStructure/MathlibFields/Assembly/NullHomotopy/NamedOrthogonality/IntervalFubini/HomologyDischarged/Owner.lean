...
/-!
# Interval-Fubini assembly with homology discharged

This file removes the cochain-homology input from the Interval-Fubini
...
null-homotopic cone identities, and Interval-Fubini numerator cancellation,
with cochain homology supplied by the abelian-envelope owner theorem. -/
def tStructureOfNullHomotopicIdentityAndIntervalFubiniHomologyDischarged
    (allBoundedStable :
...
/-- The homology-discharged Interval-Fubini assembly has the analytic motivic
`LE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndIntervalFubiniHomologyDischarged_LE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (nullHomotopicIdentity :
...
/-- The homology-discharged Interval-Fubini assembly has the analytic motivic
`GE` predicate. -/
theorem tStructureOfNullHomotopicIdentityAndIntervalFubiniHomologyDischarged_GE
    (allBoundedStable :
      ∀ object : TraceAnalyticDMgmComparisonSource,
        TraceAnalyticDMgmComparisonSource.boundedStableObject object)
    (nullHomotopicIdentity :
