...
/-!
# Projections from the homology-discharged Interval-Fubini assembly

This file exposes the orthogonality and truncation-triangle fields supplied by
the Interval-Fubini null-homotopy t-structure assembly after cochain homology
...
section HomologyDischargedIntervalFubiniInputs
...
/-- The homology-discharged Interval-Fubini assembly supplies Mathlib's
orthogonality field. -/
theorem tStructureOfNullHomotopicIdentityAndIntervalFubiniHomologyDischarged_zero
    {source target : TraceAnalyticDMgmComparisonSource}
    (hom : source ⟶ target)
    (source_mem :
      (TraceAnalyticMotivicTStructure
        .tStructureOfNullHomotopicIdentityAndIntervalFubiniHomologyDischarged
          allBoundedStable
          nullHomotopicIdentity
...
theorem tStructureOfNullHomotopicIdentityAndIntervalFubiniHomologyDischarged_exists_triangle_zero_one
    (object : TraceAnalyticDMgmComparisonSource) :
...
end HomologyDischargedIntervalFubiniInputs
