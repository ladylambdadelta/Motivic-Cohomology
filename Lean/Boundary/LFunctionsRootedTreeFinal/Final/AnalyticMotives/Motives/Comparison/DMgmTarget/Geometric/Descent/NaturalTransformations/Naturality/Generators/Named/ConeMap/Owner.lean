...
/-!
# Named generator cone-map naturality for geometric Boundary DMgm descent

This file specializes descended-natural-transformation naturality to the cone
maps of the six named stable analytic acyclic generator families, for functors
...
/-- Naturality on descent-channel stable acyclic generator cone maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_descentChannel_generator_coneMap_naturality
    (first second :
  ...
  TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_generator_coneMap_naturality
    (composition := composition)
    twistData
    first
    second
...
/-- Naturality on descent-refinement stable acyclic generator cone maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_descentRefinement_generator_coneMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on descent-schedule stable acyclic generator cone maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_descentSchedule_generator_coneMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on interval-Stokes stable acyclic generator cone maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_intervalStokes_generator_coneMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on interval-Fubini stable acyclic generator cone maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_intervalFubini_generator_coneMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
...
/-- Naturality on Tate-weight-drop stable acyclic generator cone maps in the
geometric Boundary-DMgm target. -/
theorem TraceAnalyticDMgmComparisonTarget.Geometric.descendInvertingFunctorNatTrans_tateWeightDrop_generator_coneMap_naturality
    (first second :
      TraceAnalyticAdditiveHomotopyCategory ⥤
        TraceAnalyticDMgmComparisonTarget.geometricMotives
          (composition := composition) twistData)
